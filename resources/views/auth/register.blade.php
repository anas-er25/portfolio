...
<head>
  ...
  <title>AnasFolio - register</title>
  <!--     Fonts and icons     -->
...
<body class="">
  ...
  <main class="main-content  mt-0">
    <section class="min-vh-100 mb-8">
      <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style='background-image:url("{{ url('images/curved-images/curved14.jpg') }}")'>
        <span class="mask bg-gradient-dark opacity-6"></span>
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-5 text-center mx-auto">
              <h1 class="text-white mb-2 mt-5">Welcome!</h1>
              <p class="text-lead text-white">to AnasFolio</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
            <div class="card z-index-0">
              ...
              <div class="card-body">
                ...
                @csrf
                  <div class="mb-3">
                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Name" aria-label="Name" aria-describedby="email-addon">
                  ...
                  <div class="mb-3">
                    <input type="email" placeholder="Email" aria-label="Email" aria-describedby="email-addon" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
                  ...
                  <div class="mb-3">
                    <input type="password" placeholder="Password" aria-label="Password" aria-describedby="password-addon" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                  ...
                  <div class="mb-3">
                    <input type="password" id="password-confirm" placeholder="Password" aria-label="Password" aria-describedby="password-addon" class="form-control" name="password_confirmation" required autocomplete="new-password">
                  </div>
