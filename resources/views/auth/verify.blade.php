            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  ...
                  <p class="mb-0">AnasFolio</p>
                </div>
                <div class="card-body">
                  <form role="form" action='{{ route('password.request.post') }}' method="POST">
                    @csrf
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn bg-gradient-info w-100 mt-4 mb-0"> {{ __('Reset') }}</button>
                    </div>
                  </form>
                </div>
              </div>
