...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" {{ url('/') }}" target="_blank">
                ...
                <span class="ms-1 font-weight-bold">ANASFOLIO</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link  {{ (request()->is('admin/dashboard') or request()->is('home')) ? 'active' : '' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('admin/project/create') ? 'active' : '' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('admin/resume/create') ? 'active' : '' }}"
                        href="{{ route('admin.resume.create') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <span class="nav-link-text ms-1">Resumes</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('admin/skill/create') ? 'active' : '' }}"
                    ...
                    <ul class="ms-md-auto navbar-nav  justify-content-end">
                        ...
                        @foreach($emails as $email)
                            <li>
                                <a href="javascript:;">
                                    <div>
                                        <img src="{{ asset('images/bruce-mars.jpg') }}" class="avatar avatar-sm me-3">
                                    </div>
                                    <div>
                                        <h6>{{ $email['sender'] }}</h6>
                                        <p>{{ $email['subject'] }}</p>
                ...
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-6 mb-lg-0 mb-4">
                        <div class="copyright text-center text-sm text-muted text-lg-start">
                            ...
                            <a href="{{ url('/') }}" class="font-weight-bold" target="_blank">Anas
                                ER-RAKIBI</a> .
                        </div>
                    </div>
                    <div class="col-lg-6">
    ...
    <script src="{{ asset('js/core/app.charts.js') }}"></script>
